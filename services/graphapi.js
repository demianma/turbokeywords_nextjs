...
export default function fetchFBkeywords (params) {
    ...
    const url = `https://graph.facebook.com/search?type=adinterest&q=[${params.keyword}]&limit=10000&locale=pt_BR&access_token=${token}`
